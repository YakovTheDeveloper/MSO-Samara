<template>
  <div :style="sizes" class="map">
    ...
    <span
      v-for="(battle, index) in battleStore.battles.value"
      :key="index"
      @click="chooseBattleHandler(battle)"
      class="map-battle"
      :style="getBattlePositionStyle(battle.location)"
    >
...
const sizes = computed(() => {
  return {
    transform: `scale(${1 * props.sizeCoefficient})`,
  }
})
</script>
